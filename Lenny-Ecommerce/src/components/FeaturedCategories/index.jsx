      ...
      <motion.div className={styles.container}>
        ...
        <div className={styles.categories}>
          <motion.div whileHover={{rotateY:360}} transition={{duration:0.5}} onClick={() => {
            ...
            <div className={styles.singleCategory}>
              <div className={styles.catImg}>
                <img src="/public/images/catElectronics1.png" alt="" />
              </div>
          ...
          <motion.div  whileHover={{rotateY:360}} transition={{duration:0.5}}  onClick={() => {
            ...
            <div className={styles.singleCategory}>
              <div className={styles.catImg}>
                <img src="/public/images/catFashion.png" alt="" />
              </div>
          ...
          <motion.div  whileHover={{rotateY:360}} transition={{duration:0.5}}  onClick={() => {
            ...
            <div className={styles.singleCategory}>
              <div className={styles.catImg}>
                <img src="/public/images/cataction.png" alt="" />
              </div>
          ...
          <motion.div  whileHover={{rotateY:360}} transition={{duration:0.5}} onClick={() => {
            ...
            <div className={styles.singleCategory}>
              <div className={styles.catImg}>
                <img src="/public/images/catElectronics2.png" alt="" />
              </div>
              <h2 className={styles.categoryName}>Electronics</h2>
          ...
          <motion.div  whileHover={{rotateY:360}} transition={{duration:0.5}} onClick={() => {
            ...
            <div className={styles.singleCategory}>
              <div className={styles.catImg}>
                <img src="/public/images/catBooks.png" alt="" />
              </div>
          ...
          <motion.div  whileHover={{rotateY:360}} transition={{duration:0.5}}  onClick={() => {
            ...
            <div className={styles.singleCategory}>
              <div className={styles.catImg}>
                <img src="/public/images/catGaming.png" alt="" />
              </div>

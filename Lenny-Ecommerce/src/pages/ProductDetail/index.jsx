                ...
                <li key={index}>
                  <div>
                    <div className={styles.icon}>
                      <img src="/public/images/tick-circle.jpg" alt="" />
                    </div>
            ...
            <div className={styles.bestFilters}>
              ...
              <ul className={open.best ? styles.closeFilter : ""}>
                <li>
                  <input  type="checkbox" />
                  <label htmlFor="">
                    <img src="/public/images/star.png" alt="" /> 5
                  </label>
                </li>
                <li>
                  <input type="checkbox" />
                  <label htmlFor="">
                    <img src="/public/images/star.png" alt="" /> 4
                  </label>
                </li>
                <li>
                  <input type="checkbox" />
                  <label htmlFor="">
                    <img src="/public/images/star.png" alt="" /> 3
                  </label>
                </li>
                <li>
                  <input type="checkbox" />
                  <label htmlFor="">
                    <img src="/public/images/star.png" alt="" /> 2
                  </label>
                </li>
                <li>
                  <input type="checkbox" />
                  <label htmlFor="">
                    <img src="/public/images/star.png" alt="" /> 1
                  </label>
                </li>
              </ul>
            </div>
                  ...
                  <div className={styles.singleReview}>
                    ...
                    <div className={styles.reviewUser}>
                      <div className={styles.userPhoto}>
                        <img src="/public/images/account_circle_FILL0_wght400_GRAD0_opsz24.png" />
                      </div>
